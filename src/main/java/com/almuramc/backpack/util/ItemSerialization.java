...
public class ItemSerialization
{
    ...
    private static Inventory parseInventory(NBTTagCompound root, NBTTagList itemList, String type)
    {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            if (!inputObject.isEmpty()) {
                inventory.setItem(i, CraftItemStack.asCraftMirror(net.minecraft.server.v1_8_R1.ItemStack.createStack(inputObject)));
            }
        }
        ...
        if (INVENTORY_CUSTOM.equals(type)) {
            ...
            return new OfflinePlayerInventry(inventory, root.getInt(NBT_PLAYER_HELD_INDEX), root.getString(NBT_PLAYER_NAME));
        }
        else {
    ...
    private static class ForwardingInventory implements Inventory
    {
        ...
        @Override
        public HashMap<Integer, ItemStack> addItem(ItemStack... paramArrayOfItemStack) throws IllegalArgumentException
        {
            return delegate.addItem(paramArrayOfItemStack);
        }

        @Override
        public HashMap<Integer, ItemStack> removeItem(ItemStack... paramArrayOfItemStack) throws IllegalArgumentException
        {
        ...
        @Override
        public boolean contains(Material paramMaterial, int paramInt) throws IllegalArgumentException
        {
        ...
        @Override
        public HashMap<Integer, ? extends ItemStack> all(Material paramMaterial) throws IllegalArgumentException
        {
